...
def main():
    ...
    parser.add_argument("--metrics-csv", default="outputs_phase2_pusht/videos/per_episode_metrics.csv")
    parser.add_argument("--output-dir", default="outputs_phase2_pusht/analysis")
    ...
    plt.title("PushT Phase-2 Success Rate (95% CI)")
    ...
    plt.title("PushT Phase-2 Collision Rate (95% CI)")
    plt.xticks(rotation=15)
    plt.tight_layout()
